...
![Status](https://img.shields.io/badge/상태-8편%20완결-brightgreen)

장르 불문, 설계자의 자세로 쓴 장편 소설 모음입니다.
AI 캠퍼스 연애 라이트노벨부터 이세계 판타지, 현대 헌터물, 직장 블랙코미디, 현대 무협, 관찰형 연애 리얼리티 소설까지 — **완결작 8편**을 담고 있습니다.

## 작품 목록

| 작품 | 장르 | 분량 | 상태 | 바로가기 |
| ---- | ---- | ---- | :--: | -------- |
| **유성검전(에이전트 무림 리부트)** | 현대 무협 판타지 / AI 에이전트 무림 | 프롤로그 + 본편 10부 + 에필로그 | ✅ 완결 | [작품 홈](./agent-murim/README.md) |
...
- **유성검전(에이전트 무림 리부트)** — 죽은 검성 청명이 남긴 첫 조각이 폐기장 인양 에이전트 유성을 고르고, 유성이 나머지 조각과 백야의 진실을 좇는 현대 무협 판타지.
