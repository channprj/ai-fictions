...
| 압축 파일 | 포함 범위 |
| --------- | --------- |
| [nurse-thirty-something.zip](./nurse-thirty-something.zip) | `README.md`, `00-prologue.md`~`11-epilogue.md` (전 12부) |
...
```sh
unzip nurse-thirty-something.zip
```

## 무결성 확인

```sh
shasum -a 256 nurse-thirty-something.zip
```
