...
- `vol01/00-prologue.md`, `vol01/01-part1-boot.md`, `vol01/02-part2-scapegoat.md`, `vol01/03-part3-first-query.md`, `vol01/04-part4-hallucination.md`, `vol01/README.md`(1권 본편 초고)가 작성되었다. (Phase 4 진행 중, 1권 5/12장)
- 2~12권 outline과 1권 나머지 장(05~에필로그)은 아직 없다. `TASKS.md`의 Phase 2(권별 outline)와 Phase 4(본편 초고)를 병행 진행한다.
