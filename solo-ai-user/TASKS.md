...
- `vol01/00-prologue.md`, `vol01/01-part1-boot.md`, `vol01/02-part2-scapegoat.md`, `vol01/03-part3-first-query.md`, `vol01/04-part4-hallucination.md`, `vol01/05-part5-your-call.md`, `vol01/README.md`(1권 본편 초고)가 생성되었다(Phase 4, 1권 6/12장). 1권은 outline이 완성돼 있어 본편 초고를 병행 진행한다.
- 남은 일: 2~12권 outline(Phase 2)과 1권 나머지 장 `06-part6`~`11-epilogue`(Phase 4)를 병행 진행한다.
