...
- `vol02/00-prologue.md`(2권 프롤로그 「밖」), `vol02/README.md`(2권 회차 목차)가 생성되었다(Phase 4, 2권 1/12장). 2권 본편 초고를 프롤로그부터 시작했다.
- 남은 일: 3~12권 outline(Phase 2)과 2권 본편의 `01-part1`~`11-epilogue`(Phase 4)를 진행한다.
