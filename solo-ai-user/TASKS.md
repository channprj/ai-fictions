...
- `vol02/00-prologue.md`(2권 프롤로그 「밖」), `vol02/01-part1-first-client.md`(2권 1장 「첫 의뢰」), `vol02/02-part2-the-squeeze.md`(2권 2장 「갑질」), `vol02/README.md`(2권 회차 목차)가 생성되었다(Phase 4, 2권 3/12장). 2권 본편 초고를 프롤로그·1~2장까지 집필했다.
- 남은 일: 3~12권 outline(Phase 2)과 2권 본편의 `03-part3`~`11-epilogue`(Phase 4)를 진행한다.
